...
public class baseClass {
	...
	public void setup() throws IOException {
		...
		input = new FileInputStream(System.getProperty("user.dir") + "/src/test/java/pageObjects/OR.properties");

		prop.load(input);
		// System.out.println(driver.manage().getCookies());
		/*
		 * String name = "PGSESSIONID"; String value =
		 * "YzQ5Y2Q4NTQtNDI1OS00YzNjLWE3NWYtZTk2M2U1ZDdiN2Yz"; String domain =
		 * ".magicbricks.com"; String path = "/"; //Cookie ck = new
		 * Cookie(name,value,domain,path); Cookie ck = new
		 * Cookie(name,value,domain,path,expiry,isSecure); //Cookie ck = new
		 * Cookie(name,value,domain); driver.manage().addCookie(ck);
		 */
